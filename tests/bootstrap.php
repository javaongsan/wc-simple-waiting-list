<?php
/**
 * WC_Simple_Waiting_List Test Bootstrapper.
 *
 * @since   1.0.6
 ...
 * @since 1.0.6
 */
function _manually_load_wc_simple_waiting_list_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/wc-simple-waiting-list.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_wc_simple_waiting_list_plugin' );
